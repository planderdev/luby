...
const ko = {
  ...
  ctaStart: "무료로 시작하기", ctaDash: "대시보드 바로가기", ctaCreators: "크리에이터 안내 페이지", quickStart: "Quick Start", popular: "많이 본 문서", byRole: "역할별 가이드", docsCount: (n: number) => `${n}개 문서`,
...
const en: DocsDict = {
  ...
  ctaStart: "Start for free", ctaDash: "Go to dashboard", ctaCreators: "Creator info page", quickStart: "Quick Start", popular: "Most viewed", byRole: "Guides by role", docsCount: (n) => `${n} pages`,
...
const zh: DocsDict = {
  ...
  ctaStart: "免费开始", ctaDash: "前往控制台", ctaCreators: "创作者介绍页", quickStart: "快速开始", popular: "热门文档", byRole: "按角色查看", docsCount: (n) => `${n} 篇`,
