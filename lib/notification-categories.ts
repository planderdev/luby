 ...
 * - digest:        운영자 아침 다이제스트 · 광고주 주간 성과 다이제스트
 */
...
export const EMAIL_CATEGORY_LABEL: Record<EmailCategory, { label: string; desc: string }> = {
  ...
  digest: { label: "다이제스트", desc: "광고주: 매주 월요일 지난주 캠페인 성과 요약 · 운영자: 아침 처리 대기 업무 요약" },
};
...
const DIGEST_TYPES = new Set(["operator_daily_digest", "advertiser_weekly_digest"]);
